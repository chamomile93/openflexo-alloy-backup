...
package org.openflexo.ta.alloy.gui;
...
public class AlloyIconLibrary {
	...
	private static final Logger logger = Logger.getLogger(AlloyIconLibrary.class.getPackage().getName());

	public static final ImageIconResource Alloy_TA_BIG_ICON = new ImageIconResource(ResourceLocator.locateResource("Icons/alloy-ta-32x32.png"));

	public static final ImageIconResource Alloy_TA_ICON = new ImageIconResource(ResourceLocator.locateResource("Icons/alloy-ta-16x16.png"));
