...
package org.openflexo.ta.alloy.controller;
...
public class AlloyAdapterController extends TechnologyAdapterController<AlloyTechnologyAdapter> {

	static final Logger logger = Logger.getLogger(AlloyAdapterController.class.getPackage().getName());

	private InspectorGroup alloyInspectorGroup;
	...
	protected void initializeInspectors(FlexoController controller) {
		...
		alloyInspectorGroup = controller.loadInspectorGroup("Alloy", getTechnologyAdapter().getLocales(),
	...
	public ImageIcon getTechnologyBigIcon() {
		return AlloyIconLibrary.Alloy_TA_BIG_ICON;
	}
	...
	public ImageIcon getTechnologyIcon() {
		return AlloyIconLibrary.Alloy_TA_ICON;
	}
	...
	public ImageIcon getModelIcon() {
		return AlloyIconLibrary.Alloy_TEXT_ICON;
	}
