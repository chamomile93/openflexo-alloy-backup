...
public interface DSLObject extends FlexoObject, InnerResourceData<DSLModule>, TechnologyObject<DSLTechnologyAdapter> {
	 ...
	 * Assert that the {@link DSLModule} (the ResourceData) in which this object is stored is kwown<br>
