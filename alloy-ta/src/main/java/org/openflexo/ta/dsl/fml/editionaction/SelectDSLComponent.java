...
/**
 * A {@link FetchRequest} allowing to retrieve a selection of some {@link DSLComponent} matching some conditions
 * 
 * @author sylvain
 * 
 */
...
public interface SelectDSLComponent
		extends AbstractSelectDSLComponent<List<DSLComponent>>, FetchRequest<DSLModelSlot, DSLModule, DSLComponent> {
