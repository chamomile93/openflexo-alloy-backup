...
public interface AbstractSelectDSLLink<AT> extends AbstractFetchRequest<DSLModelSlot, DSLModule, DSLLink, AT> {

	public static abstract class AbstractSelectDSLLinkImpl<AT> extends AbstractFetchRequestImpl<DSLModelSlot, DSLModule, DSLLink, AT>
		...
		public List<DSLLink> performExecute(RunTimeEvaluationContext evaluationContext) {
			...
			DSLModule resourceData = getReceiver(evaluationContext);
