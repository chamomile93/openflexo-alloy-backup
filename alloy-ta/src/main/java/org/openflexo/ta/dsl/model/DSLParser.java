...
public class DSLParser {
	 ...
	 * Syntaxic and semantics analyzer are performed and returned value is a {@link DSLModule}
	 * 
	 * @param inputStream
	 ...
	 * @throws IOException
	 */
	public static DSLModule parse(InputStream inputStream, DSLModelFactory modelFactory) throws ParseException, IOException {
	 ...
	 */
	public static DSLModule parse(String data, DSLModelFactory modelFactory) throws ParseException {
		try {
