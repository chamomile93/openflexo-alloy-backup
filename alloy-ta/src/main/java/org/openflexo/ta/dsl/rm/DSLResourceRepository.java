 ...
 */
@ModelEntity
public interface DSLResourceRepository<I> extends TechnologyAdapterResourceRepository<DSLResource, DSLTechnologyAdapter, DSLModule, I> {
