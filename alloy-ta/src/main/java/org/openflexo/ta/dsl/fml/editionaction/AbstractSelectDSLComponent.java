...
public interface AbstractSelectDSLComponent<AT> extends AbstractFetchRequest<DSLModelSlot, DSLModule, DSLComponent, AT> {

	public static abstract class AbstractSelectDSLComponentImpl<AT>
			extends AbstractFetchRequestImpl<DSLModelSlot, DSLModule, DSLComponent, AT> implements AbstractSelectDSLComponent<AT> {
