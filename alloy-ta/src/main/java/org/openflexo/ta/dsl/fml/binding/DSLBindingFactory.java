...
package org.openflexo.ta.dsl.fml.binding;
...
/**
 * Defines DSL-specific types binding path element strategy<br>
 * 
 ...
 *
 */
public final class DSLBindingFactory extends TechnologyAdapterBindingFactory {
	static final Logger logger = Logger.getLogger(DSLBindingFactory.class.getPackage().getName());

	public DSLBindingFactory() {
		super();
	}
