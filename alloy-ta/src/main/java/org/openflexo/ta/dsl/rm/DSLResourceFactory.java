...
public class DSLResourceFactory
		extends TechnologySpecificPamelaResourceFactory<DSLResource, DSLModule, DSLTechnologyAdapter, DSLModelFactory> {
	...
	@Override
	public DSLModule makeEmptyResourceData(DSLResource resource) {
		return resource.getFactory().makeEmpty();
	}
