...
import org.openflexo.ta.dsl.model.DSLModule;
...
/**
 * Default implementation for a resource storing a {@link DSLModule}
 * 
 * @author sylvain
 *
 */
public abstract class DSLResourceImpl extends PamelaResourceImpl<DSLModule, DSLModelFactory> implements DSLResource {
	 ...
	 */
	@Override
	public Class<DSLModule> getResourceDataClass() {
		return DSLModule.class;
	}
	 ...
	 * @throws IOException
	 */
	private <I> DSLModule loadDocument(StreamIODelegate<I> ioDelegate) throws IOException {
		...
		try {
			DSLModule returned = DSLParser.parse(ioDelegate.getInputStream(), getFactory());
