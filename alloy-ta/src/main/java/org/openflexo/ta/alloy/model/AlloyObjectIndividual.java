 ...
 * @author chamomile93
 */
public class AlloyObjectIndividual<T extends Object> extends FlexoOntologyObjectImpl<AlloyTechnologyAdapter>
		implements InnerResourceData<AlloyModel>,
		IFlexoOntologyIndividual<AlloyTechnologyAdapter> {

	private static final Logger logger =
			Logger.getLogger(AlloyObjectIndividual.class.getPackage().getName());

	protected final AlloyModel ontology;
	/** Alloy Object Wrapped. */
	protected final T object;

	public AlloyObjectIndividual(AlloyModel ontology, T object) {
	 ...
	 */
	@Override
	public IFlexoOntologyPropertyValue<AlloyTechnologyAdapter> getPropertyValue(
			IFlexoOntologyStructuralProperty<AlloyTechnologyAdapter> property) {
		IFlexoOntologyPropertyValue<AlloyTechnologyAdapter> result = null;
		for (IFlexoOntologyPropertyValue<AlloyTechnologyAdapter> propertyValue :
				getPropertyValues()) {
	 ...
	 */
	@Override
	public IFlexoOntologyPropertyValue<AlloyTechnologyAdapter> removeFromPropertyValue(
			IFlexoOntologyStructuralProperty<AlloyTechnologyAdapter> property,
