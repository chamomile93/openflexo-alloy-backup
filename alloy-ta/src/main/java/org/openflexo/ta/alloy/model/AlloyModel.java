...
public class AlloyModel  extends FlexoOntologyObjectImpl<AlloyTechnologyAdapter>
		implements FlexoModel<AlloyModel, AlloyMetaModel>,
		IFlexoOntology<AlloyTechnologyAdapter>
{
	protected static final Logger logger =
			Logger.getLogger(AlloyModel.class.getPackage().getName());

	protected AlloyModelResource modelResource;
	// TODO might need to implement a meta model like "{@ AlloyMetaModel}"
	protected final AlloyMetaModel alloyMetaModel;
	// TODO idf yet
	protected final AlloyModelConverter converter;
	protected  final Object resource;

	public AlloyModel(AlloyModelConverter converter, Object resource) {
		this.alloyMetaModel = null;
		this.converter = converter;
		this.resource = resource;
	}

	public AlloyModel(AlloyMetaModel alloyMetaModel,
                      AlloyModelConverter converter, Object resource) {
	...
	public void setName(String name) throws Exception {
		logger.log(Level.INFO, "AlloyModel.setName() called but nothing " +
				"happens");
	}
	...
	public List<? extends IFlexoOntologyConcept<AlloyTechnologyAdapter>> getConcepts() {
		List<IFlexoOntologyConcept<AlloyTechnologyAdapter>> concepts =
				new ArrayList<>();
