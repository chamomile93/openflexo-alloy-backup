...
package org.openflexo.ta.alloy.fml.binding;
...
/**
 * This class represent the {@link BindingFactory} dedicated to handle Alloy technology-specific binding elements
 * @author chamomile93
 *
 */
public final class AlloyBindingFactory extends TechnologyAdapterBindingFactory {
	static final Logger logger = Logger.getLogger(AlloyBindingFactory.class.getPackage().getName());

	public AlloyBindingFactory() {
		super();
	}
