...
//		}
	...
	public void activate() {
		logger.info("START AlloyTechnologyAdapter.activate()");
		/**
		 ...
		 */
		logger.info("AlloyTechnologyAdapter.super.activate()");
		super.activate();
		logger.info("AlloyTechnologyAdapter.super.activate() done");
		logger.info("AlloyTechnologyAdapter.activate() registerClassPathMetaModels");
		/**
		...
		logger.info("AlloyTechnologyAdapter.activate() registerClassPathMetaModels done");
		logger.info("END AlloyTechnologyAdapter.activate()");
	}
	...
	private void registerClasspathMetaModels() {
		logger.info("START AlloyTechnologyAdapter.registerClassPathMetaModels()");
		 ...
		 * what is the representation ?
 		 */
		logger.info("AlloyTechnologyAdapter.registerClassPathMetaModels() alloyMetaModelResource=" + alloyMetaModelResource);

		logger.info("START AlloyTechnologyAdapter.registerClassPathMetaModels() retrieveResourceFromClassPath with  factoryClassName = " + ECORE_MM_FACTORYCLSNAME + " ALLOY_MM_NAME= " + ALLOY_MM_NAME + " ECORE_MM_URI= " + ECORE_MM_URI + " ECORE_MM_EXT= " + ECORE_MM_EXT + " ECORE_MM_PKGCLSNAME= " + ECORE_MM_PKGCLSNAME + " getTechnologyContextManager=" + getTechnologyContextManager().getClass().getSimpleName());
		...
		logger.info("END AlloyTechnologyAdapter.registerClassPathMetaModels() retrieveResourceFromClassPath  with  factoryClassName = " + ECORE_MM_FACTORYCLSNAME + " ALLOY_MM_NAME= " + ALLOY_MM_NAME + " ECORE_MM_URI= " + ECORE_MM_URI + " ECORE_MM_EXT= " + ECORE_MM_EXT + " ECORE_MM_PKGCLSNAME= " + ECORE_MM_PKGCLSNAME + " getTechnologyContextManager=" + getTechnologyContextManager().getClass().getSimpleName());

		logger.info("AlloyTechnologyAdapter.registerClassPathMetaModels() alloyMetaModelResource=" + alloyMetaModelResource);

		logger.info("END AlloyTechnologyAdapter.registerClassPathMetaModels()");
	}
